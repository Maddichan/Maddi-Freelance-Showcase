...
## 🔀 Step 1: Carrier Selection Matrix

Select the appropriate carrier and service level based on destination, speed requirements, item weight, and cost profiles:
...
## 📦 Step 2: Packaging & Dimensional Verification

1. **Select Package Outer:** Choose an appropriately sized box or mailer that leaves 2 inches of space around all sides of the item.
2. **Apply Cushioning:** Wrap items in bubble wrap or place minimum 2 inches of void fill at the bottom, sides, and top.
3. **Seal Package:** Use H-taping method with heavy-duty pressure-sensitive tape across all seams.
4. **Weigh & Measure:**
   * Measure Length, Width, and Height (L x W x H) rounded up to the nearest inch/centimeter.
   * Place the package on the scale and record exact weight rounded up to the nearest ounce/gram.
   * *Note:* Incorrect weight/dimensions trigger post-shipment carrier billing adjustments.
...
## 🚚 Step 4: Dispatch & Pickup Coordination
...
[← Return to Technical Documentation Folder](./README.md)
